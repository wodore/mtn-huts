...
def get_user_language():
    ...
    lang = werkzeug.datastructures.LanguageAccept([(al[0][0:2], al[1]) for al in request.accept_languages]).best_match(
        Config.LANGUAGES
    )
    if not lang:
        lang = "en"
...
def inject_conf_var():
    ...
    return {"CURRENT_LANGUAGE": lang, "lang": lang}
