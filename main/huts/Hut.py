...
class Hut(object):
    ...
    def __init__(self, hut_dict, start_date='now', days_from_start_date=0, 
        ...
        if start_date:
            ...
            self._start_date = (start_datetime + datetime.timedelta(days=days_from_start_date)).strftime("%d.%m.%Y")
        else:
    ...
    def owner(self):
        """Returns hut owner"""
        return self._hut_dict.get('owner', "")
    ...
    def get_capacity(self):
        ...
        if self._capacity_loading_p.is_alive():
